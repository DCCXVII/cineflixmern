...
const Navbar = ({ buttonText }) => {
  return (
    <>
      {/* bg-ebony-clay-950 */}
      <div className="w-screen h-14 font-blinker backdrop-blur-2xl fixed shadow  z-10 ">
        <div className="containe mx-auto">
          <div className="w-full flex justify-between items-center py-2 px-8">
            ...
            <div className="items-center h-fit  flex">
              <a
                href="/login"
                className="bg-slate-900  rounded-xl text-base flex justify-center items-center text-center hover:bg-slate-950  text-white-100 no-underline mx-2 px-4 py-2"
              >
